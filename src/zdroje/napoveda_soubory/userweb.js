...
JAK.Help.prototype._clickClose = function(e,elm){
	...
	while (node != document.body) {
	    if (node == this.bubble) { return false; break; }
...
JAK.Help.prototype._startBubble = function(e,elm) {
	...
	this._showTimeout = setTimeout(this.fillBubble, 1000); /* fillbubble musi byt zbindovana! */
}
/**
...
JAK.Help.prototype._stopBubble = function(e,elm) {
    if(!this.closeClickAction){
	    this.closeClickAction = JAK.Events.addListener(window,'click',this,'_clickClose'); /* zavirani na kliknuti */
	}
